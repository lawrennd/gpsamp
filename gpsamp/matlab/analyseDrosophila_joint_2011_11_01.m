...
hold off
legends = {'MAP-32', 'MAP-32 + prior', 'MAP-16', 'MAP-16 + prior', 'ML-Baseline', 'Regression', 'Inferelator (only for 6003 genes)', 'Uniform prior', 'Empirical prior', 'Location', 'EastOutside'};
...
if printPlot 
   ...
   print(h1c, '-depsc2', [ddir 'drosophilaBars_' 'EnrichmentGlobalMAPNeg' num2str(2) '_', property '.eps']);
