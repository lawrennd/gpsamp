...
drosPrintBootstrapResults(res3(:, :, 1:3), 1:4, {'P32', 'P4', 'ML', 'Inf'}, T2(1:3), '../tex/tables/bootstrap3_1.tex')
drosPrintBootstrapResults(res3(:, :, 4:6), 1:4, {'P32', 'P4', 'ML', 'Inf'}, T2(4:6), '../tex/tables/bootstrap3_2.tex')
drosPrintBootstrapResults(res3(:, :, 5:7), 1:4, {'P32', 'P4', 'ML', 'Inf'}, T2(5:7), '../tex/tables/bootstrap3_3.tex')
