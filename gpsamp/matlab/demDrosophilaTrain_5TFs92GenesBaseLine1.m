...
% separate are normalized separately 
if normGenes == 1
%    
...
model.Likelihood.singleAct = 'lin'; 
...
% adaption and training phase
[model PropDist samples accRates] = gpmtfBaselineMultTFModel(model, mcmcoptions);
