...
if strcmp(method, 'margLogLik1')
  ...
  for c=1:size(testGenes,2) 
    ...
    if isfield(testGenes{k,c}, 'W')
       X = [testGenes{k,c}.kinetics; testGenes{k,c}.W; testGenes{k,c}.W0; testGenes{k,c}.sigma2]';
       %X = [testGenes{k,c}.kinetics; testGenes{k,c}.W; testGenes{k,c}.W0]';
    else
       X = [testGenes{k,c}.kinetics; testGenes{k,c}.sigma2]'; 
    ...
    LogMargL(k,c) = mean(testGenes{k,c}.LogL) + mean(testGenes{k,c}.LogPrior) + entropy;
    %
  end
  end
