...
if model.Likelihood.numTFs == 0
   gpmtfPlotOnlyDecayModel(model, Genes, GeneVars, fbgn, samples, demdata, printResults, Grtruth);
   return;
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function gpmtfPlotOnlyDecayModel(model, Genes, GeneVars, fbgn, samples, demdata, printResults, Grtruth)
...
TimesG = model.Likelihood.TimesG; 
ok = date;
fileName = [demdata 'Test' 'MCMC' ok 'onlyDecay' char(fbgn)]; 
...
for t=1:NumOfSamples
  ...
  GG(t,:) = B/DD  + (A - B/DD)*exp(-TimesG*DD);
  %
end
...
figure;
errorbar(TimesG,  mu, 2*sqrt(stds), 'b','lineWidth', 1.5);
hold on; 
plot(TimesG, Genes(1,:,r),'rx','markersize', 14','lineWidth', 2);
if model.Likelihood.noiseModel.active(1) == 1 & sum(model.Likelihood.noiseModel.active(2:3)==0)
    errorbar(TimesG,  Genes(1,:,r), 2*sqrt(GeneVars(1,:,r)), 'rx','lineWidth', 1.5);
