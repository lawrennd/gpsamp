...
%    
    ...
    load demtoy_dataOtherCond109-Sep-2011.mat
    noiseM = {'white'};
    testsetIndices = (30+remainder):modulus:1030;
    Genes = Genes(testsetIndices, :, 2); 
    GenesVar = GenesVar(testsetIndices, :, 2);
...
%  
    ...
    outfile = sprintf('%s/multitfToyOtherCond6a_%s_m%d_r%d.mat', outdir, identifier, modulus, remainder);

    dataName = 'toy_dataOtherCond';
    expNo = 1;
    storeRes = 0;
    printPlot = 0;
    noiseM = {'white'};
