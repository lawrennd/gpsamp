% demToyTest_3TFsTwoCondsAllModels1.m runs the multi-TF for screening
% using all possible combinations of 3 TFs in toy data. One experimental
% condition is used 
function [Genes, GenesVar, TFs, models, mygenes] = demToyTest_3TFsTwoCondsAllModels1(modulus, remainder, identifier, flag)
...
%  
    ...
    outfile = sprintf('%s/multitfToyTwoConds6a_%s_m%d_r%d.mat', outdir, identifier, modulus, remainder);
